...
<head>
  <meta charset="UTF-8" />
  <title>@All_in_one_reborn_bd</title>
...
<body>
  <div class="container">
    ...
    <!-- Header -->
    <header class="header">
      <div class="logo">ALL IN ONE REBORN BD</div>
      <button class="menu-btn" id="menuBtn"><i class="fas fa-bars"></i></button>
      <div class="dropdown-menu" id="dropdownMenu">
        <a href="ht5S-lx5CxGJEallonebdlankrget="_blank"><i class="fab fa-telegram-plane"></i> Join Telegram</a>
        <a href="https://youtube.com/@itsmeratulfti">About</a>
        <a href="https://t.me/chatbotratul_bot">Contact</a>
      </div>
    </header>
  ...
  <div class="notice-text">
   ভিডিও লোড হতে ৮-১০ সেকেন্ড লাগতে পারে , আপনার নেটওয়ার্ক এর উপর নির্ভশীল। ভিডিও অটো কোয়ালিটি তে প্লে হতে যেয়ে যদি ল্যাগ করে ।কাস্টম কোয়ালিটি সিলেক্ট করে নিন।৩০ সেকেন্ড এর ভিতর প্লে না হলে অন্য সার্ভার সিলেক্ট করে নিন। কোনো সমস্যা হলে 3 লাইন মেনু থেকে যোগাযোগ করুন ।
  </div>
              </div>
    ...
    <!-- Footer -->
    <footer class="footer">&copy; 2025 ALL IN ONE REBORN BD. All Rights Reserved. 🇧🇩</footer>
  </div>
